...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">100% <small>(352 / 352)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">94.44% <small>(119 / 126)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(144 / 144)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(331 / 331)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
2616
2617
2618</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  asso: function(fn, argObj) {
    ...
    var args = len &lt; 3 ? <span class="branch-0 cbranch-no" title="branch not covered" >argObj </span>: _.toArray(argObj),
...
&nbsp;
  ...
  reMatch: function(regex) {
    return function(str) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (str != undefined)
...
&nbsp;
  ...
  seq: function(start, stop, step) {
    if (stop == null) {
      stop = start || <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
      start = 1;
    }
    step = step || 1;
...
&nbsp;
  ...
  expVal: function(X, P, fn) {
    ...
    // if X, fn specified
    else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof P === 'function'){
      var hist = lomath.histogram(X);
      val = hist.value,
      prob = hist.prob;
      func = P;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Jul 14 2015 14:46:12 GMT-0400 (EDT)</div>
</div>
